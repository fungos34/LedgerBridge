    ...
    if not settings.configured:
        settings.configure(
            ...
            TEMPLATES=[{
                ...
                'DIRS': [Path(__file__).parent.parent / 'src' / 'paperless_firefly' / 'review' / 'web' / 'templates'],
                'APP_DIRS': True,
            }],
...
class TestConfidenceDisplay:
    ...
    def test_confidence_thresholds_classification(self):
        ...
        from paperless_firefly.schemas.finance_extraction import ReviewState, ConfidenceScores
...
class TestStatsCalculation:
    ...
    def test_get_stats(self, populated_state_db):
        ...
        assert "documents_processed" in stats or "total_documents" in stats or isinstance(stats, dict)
