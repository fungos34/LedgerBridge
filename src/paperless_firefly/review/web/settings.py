...
INSTALLED_APPS = [
    ...
    "paperless_firefly.review.web.apps.WebConfig",  # Use AppConfig for background worker
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "paperless_firefly.review.web.context_processors.llm_settings",
                "paperless_firefly.review.web.context_processors.page_context",
            ],
        },
    },
]
