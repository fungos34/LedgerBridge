    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rules_applied",
                    models.TextField(blank=True, help_text="JSON rules applied", null=True),
                ),
                (
                    "llm_result",
                    models.TextField(blank=True, help_text="JSON LLM result if used", null=True),
                ),
                ("final_state", models.TextField()),
                ("suggested_category", models.TextField(blank=True, null=True)),
                (
                    "suggested_splits",
                    models.TextField(blank=True, help_text="JSON splits if applicable", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firefly_id",
                    models.IntegerField(blank=True, help_text="NULL for orphans", null=True),
                ),
                (
                    "link_type",
                    models.TextField(
                        default="PENDING", help_text="PENDING, LINKED, ORPHAN, or AUTO_LINKED"
                    ),
                ),
                (
                    "confidence",
                    models.FloatField(blank=True, help_text="Match confidence 0.0-1.0", null=True),
                ),
                (
                    "match_reasons",
                    models.TextField(
                        blank=True, help_text="JSON array of match reasons", null=True
                    ),
                ),
                ("linked_at", models.TextField()),
                (
                    "linked_by",
                    models.TextField(blank=True, help_text="AUTO, USER, etc.", null=True),
                ),
                ("notes", models.TextField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "match_reasons",
                    models.TextField(blank=True, help_text="JSON array of reasons", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firefly_url",
                    models.URLField(
                        blank=True, default="", help_text="Override default Firefly URL"
                    ),
                ),
                (
                    "default_source_account",
                    models.CharField(blank=True, default="Checking Account", max_length=255),
                ),
                (
                    "auto_import_threshold",
                    models.FloatField(default=0.85, help_text="Auto-import confidence threshold"),
                ),
                (
                    "review_threshold",
                    models.FloatField(default=0.6, help_text="Review confidence threshold"),
                ),
                (
                    "syncthing_url",
                    models.URLField(
                        blank=True,
                        default="",
                        help_text="URL to Syncthing web UI for document syncing",
                    ),
                ),
                (
                    "importer_url",
                    models.URLField(
                        blank=True,
                        default="",
                        help_text="URL to Firefly Importer for bank statement imports",
                    ),
                ),
