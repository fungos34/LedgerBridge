...
class ExtractorRouter:
    ...
    def extract(
        ...
        proposal = TransactionProposal(
            ...
            source_account=default_source_account if transaction_type == TransactionType.WITHDRAWAL else None,
        ...
        for i, item_data in enumerate(extraction_result.line_items):
            line_items.append(LineItem(
                ...
                tax_rate=Decimal(str(item_data["tax_rate"])) if item_data.get("tax_rate") else None,
                position=i + 1,
            ))
